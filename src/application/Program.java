...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("Digite a ID do vendedor"); int idv = sc.nextInt();
		 * sc.nextLine(); seller = sellerDao.findById(idv);
		 * System.out.println("Digite o Nome do Vendedor:"); String nameV =
		 * sc.nextLine(); seller.setName(nameV); sellerDao.update(seller);
		 */
		
		System.out.println("\n\n=======TESTE 6: Seller DELETE ===========");
		System.out.println("Enter id for delete byID:");
		int id = sc.nextInt();
